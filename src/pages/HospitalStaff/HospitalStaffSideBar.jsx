...
import { FaTachometerAlt, FaUserMd, FaBars, FaTimes, FaStethoscope } from "react-icons/fa";
...
const HospitalStaffSideBar = () => {
  ...
  const menuItems = [
    { name: "Dashboard", icon: FaTachometerAlt, path: "/healthCareStaff/dashboard" },
    { name: "Doctors", icon: FaStethoscope, path: "/healthCareStaff/doctors" }, // New Link
  ];
