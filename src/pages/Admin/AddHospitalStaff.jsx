    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-100 via-blue-300 to-blue-500 px-4">
      <form onSubmit={handleSubmit} className="w-full max-w-md bg-white rounded-xl shadow-lg p-6 space-y-6">
        <div className="flex flex-col items-center mb-2">
          ...
          <h1 className="text-2xl font-bold text-blue-700 mb-2 text-center">Add Hospital Staff</h1>
          <p className="text-gray-500 text-sm text-center">Enter staff details below</p>
        </div>
        <div>
        ...
        <div>
          ...
          <select value={role} onChange={(e)=>setRole(e.target.value)} required className="w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-400 transition">
            <option value="">Choose Role</option>
            <option value="HEALTHCAREMANAGER">Health care Manager</option>
